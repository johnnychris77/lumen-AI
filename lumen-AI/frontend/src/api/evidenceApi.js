...
export async function linkEvidenceToVisualReview(evidenceId, reviewId) {
  const response = await fetch(
    `${API_BASE_URL}/api/evidence/${evidenceId}/link-to-visual-review/${reviewId}`,
    {
      method: "POST",
      headers: {
        Authorization: "Bearer dev-token",
...
export async function linkEvidenceToInspection(evidenceId, inspectionId) {
  const response = await fetch(
    `${API_BASE_URL}/api/evidence/${evidenceId}/link-to-inspection/${inspectionId}`,
    {
      method: "POST",
      headers: {
        Authorization: "Bearer dev-token",
...
export async function linkEvidenceToCapa(evidenceId, capaId) {
  const response = await fetch(
    `${API_BASE_URL}/api/evidence/${evidenceId}/link-to-capa/${capaId}`,
    {
      method: "POST",
      headers: {
        Authorization: "Bearer dev-token",
