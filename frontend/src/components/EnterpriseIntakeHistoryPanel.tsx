...
export default 
function GovernanceBaselineEvidenceSection({
  items,
}: {
  ...
  if (!baselines.length) {
    return (
      <div style={baselineEvidenceEmptyStyle}>
  ...
  return (
    <div style={baselineEvidenceSectionStyle}>
      <div style={baselineEvidenceHeaderStyle}>
        <div>
          <h4 style={sectionTitleStyle}>Manufacturer Baseline Evidence</h4>
          <p style={mutedTextStyle}>
            Approved manufacturer or new-condition reference evidence supporting baseline comparison and vendor-quality decisions.
          </p>
        </div>
        <span style={baselineCountBadgeStyle}>
      ...
      {baselines.map((baseline) => (
        <div key={baseline.baseline_id} style={baselineEvidenceCardStyle}>
          <div style={baselineCardHeaderStyle}>
            <strong>Baseline #{baseline.baseline_id}</strong>
            <span style={baselineStatusBadgeStyle(baseline.baseline_status || "")}>
              {formatStatusLabel(baseline.baseline_status || "unknown")}
            </span>
          </div>

          <div style={baselineDetailGridStyle}>
            <div>
          ...
          <div style={baselineNarrativeStyle}>
...
function EnterpriseIntakeHistoryPanel() {
    ...
    <div style={detailPanelStyle}>
      <div style={detailHeaderStyle}>
        <div>
          ...
          <GovernanceBaselineEvidenceSection items={packet.baseline_evidence} />
...
const baselineEvidenceEmptyStyle: React.CSSProperties = {
  marginTop: "16px",
  padding: "14px",
  borderRadius: "16px",
...
const baselineEvidenceHeaderStyle: React.CSSProperties = {
  display: "flex",
  justifyContent: "space-between",
  gap: "12px",
  alignItems: "flex-start",
...
const baselineCountBadgeStyle: React.CSSProperties = {
  borderRadius: "999px",
  padding: "6px 10px",
  background: "#dbeafe",
  color: "#1e40af",
...
const baselineCardHeaderStyle: React.CSSProperties = {
  display: "flex",
  justifyContent: "space-between",
  alignItems: "center",
  gap: "10px",
...
function baselineStatusBadgeStyle(status: string): React.CSSProperties {
...
const baselineDetailGridStyle: React.CSSProperties = {
  display: "grid",
  gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))",
  gap: "10px",
};

const baselineNarrativeStyle: React.CSSProperties = {
  marginTop: "12px",
  paddingTop: "12px",
